...
This folder centralizes non-root project docs for portfolio and contribution clarity.
...
- `docs/screenshots/app-home-light.png`
- `docs/screenshots/app-home-dark.png`
- `docs/screenshots/app-input.png`
- `docs/screenshots/app-output-light-1.png`
- `docs/screenshots/app-output-dark-1.png`
- `docs/screenshots/app-output-light-2.png`
- `docs/screenshots/app-output-dark-2.png`
